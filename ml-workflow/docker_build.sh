...
PROJECT_NAME="mlops-rakuten-flyte"
...
do
    case "${flag}" in
        ...
        h) echo "Usage: ${0} [-h|[-p <project_name>][-r <registry_name>][-v <version>]]"
           ...
           echo "  p: PROJECT_NAME for your workflows. Defaults to 'my_project'."
...
docker push ${TAG}
echo "Docker image built and pushed with tag ${TAG}. You can use this image to run pyflyte package."
